...
Bổ sung quan trọng: tiêu chuẩn sai số tính được. Tiêu chuẩn theo khoảng cách tới nghiệm chiếu chính xác không thực thi được, nên chế độ ngân sách cố định nằm ngoài định lý. Cách vá đã cài đặt và kiểm chứng: vì hàm mục tiêu của bài toán chiếu lồi mạnh với tham số 1, khoảng cách đối ngẫu cho chặn trên tính được của sai số chiếu, bằng căn của hai lần khoảng cách đối ngẫu, tính trực tiếp từ cặp biến gốc và đối ngẫu của Chambolle-Pock. Từ đó dựng được chế độ ngân sách thích nghi chạy vòng lặp nội tới khi chứng chỉ đạt lịch sai số đặt trước; đây là chế độ duy nhất thực thi được đúng như định lý đòi hỏi, và nó cho nghiệm khả thi tuyệt đối. Số liệu: chế độ thích nghi rẻ hơn chiếu chính xác 2,16 lần khi cả hai cùng dùng chứng chỉ tính được. Cái giá là chứng chỉ bi quan, tốn khoảng 2,6 đến 5,8 lần nhiều bước hơn tiêu chuẩn lý tưởng; bài phải nêu rõ điều này.
