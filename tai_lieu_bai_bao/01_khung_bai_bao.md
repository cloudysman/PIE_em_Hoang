...
Thứ nhất, về tốc độ của vòng lặp nội. Vòng lặp Chambolle-Pock cơ bản cho phép chiếu lên quả cầu biến phân toàn phần chỉ hội tụ với tốc độ cỡ nghịch đảo số bước, không phải tuyến tính, vì bài toán đối ngẫu không lồi mạnh. Do đó câu chuyện sai số giảm nhanh cần một biến thể tăng tốc hoặc một điều kiện chặn sai số bổ sung, và bài phải phát biểu điều này tường minh thay vì giả định tốc độ tuyến tính. Đã thử biến thể tăng tốc khai thác tính lồi mạnh và nó không cải thiện trong chế độ khởi tạo ấm với ngân sách nhỏ; chi tiết và số liệu ở mục 2b của báo cáo số. Cách xử lý được chọn là chuyển sang tiêu chuẩn sai số tính được, xem mục kế tiếp.

Bổ sung quan trọng: tiêu chuẩn sai số tính được. Tiêu chuẩn theo khoảng cách tới nghiệm chiếu chính xác không thực thi được, nên chế độ ngân sách cố định nằm ngoài định lý. Cách vá đã cài đặt và kiểm chứng: vì hàm mục tiêu của bài toán chiếu lồi mạnh với tham số 1, khoảng cách đối ngẫu cho chặn trên tính được của sai số chiếu, bằng căn của hai lần khoảng cách đối ngẫu, tính trực tiếp từ cặp biến gốc và đối ngẫu của Chambolle-Pock. Từ đó dựng được chế độ ngân sách thích nghi chạy vòng lặp nội tới khi chứng chỉ đạt lịch sai số đặt trước; đây là chế độ duy nhất thực thi được đúng như định lý đòi hỏi, và nó cho nghiệm khả thi tuyệt đối.

Số liệu, đo trên GPU với ảnh cạnh 96 điểm ảnh, 150 bước ngoài và 8 ảnh, theo giao thức công bằng: thời gian thuật toán tách khỏi chi phí đo đạc và đồng bộ hóa GPU, mức phần dư mục tiêu ấn định trước độc lập với mọi cấu hình, và hai nhóm được dò với cùng ngân sách tám cấu hình. Cả chế độ thích nghi lẫn chiếu chính xác đều dùng chứng chỉ tính được, không bên nào mượn oracle.

Kết quả: chế độ thích nghi rẻ hơn chiếu chính xác 13,2 đến 19,2 lần theo bước nội và 5,1 đến 9,7 lần theo thời gian thuật toán trên mờ Gauss; trên mờ chuyển động là 17,2 đến 23,6 lần theo bước nội và 6,2 đến 8,7 lần theo thời gian. Lợi thế tồn tại ở cả hai thước đo và ổn định qua mọi mức phần dư mục tiêu. Mọi cấu hình cho nghiệm khả thi tuyệt đối.

Lịch sử số liệu, để không lặp lại sai lầm: bản đo trước từng báo 12,86 và 14,90 lần chỉ theo bước nội mà không đo thời gian, và một vòng phản biện sau đó tính ra 1,18 lần từ cột thời gian tổng vốn bị chi phí đo đạc nhấn chìm. Cả hai đều sai; con số ở trên mới là con số đo đúng. Chi tiết ở mục 2f của báo cáo số. Cái giá và giới hạn phải nêu rõ: chứng chỉ bi quan nên tốn khoảng 2,6 đến 5,8 lần nhiều bước hơn tiêu chuẩn lý tưởng không tính được; việc chọn lịch quyết định kết quả, lịch quá siết làm chi phí bùng nổ tới mức tệ hơn chiếu chính xác khoảng 50 lần; và hệ số tiết kiệm được đo tại một mức phần dư mục tiêu cụ thể, nếu đòi phần dư thấp hơn nhiều thì chế độ thích nghi thua. Quy luật chọn lịch: số mũ sát 1 từ phía trên, hệ số đầu lớn cỡ 2 đến 4.
